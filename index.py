...
class MoneyTransfer:
    ...
    def transfer_money(
        self, sender_id, receiver_id, amount, sender_currency, receiver_currency
    ):
    ...
    def _convert_currency(self, amount, from_currency, to_currency):
        ...
        try:
            ...
            raise CurrencyConvertionRateNotFoundException(
                f"Conversion rate not available for {from_currency} to {to_currency}"
            )


moneyTransfer = MoneyTransfer(
    user_accounts=users_accounts, conversion_rates=conversion_rate
)
